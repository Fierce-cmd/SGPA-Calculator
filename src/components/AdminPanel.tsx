...
export function AdminPanel({ curriculumMap, onCurriculumChange }: AdminPanelProps) {
  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-md mx-auto mt-12 bg-white dark:bg-black p-8 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 bg-black dark:bg-white text-white dark:text-black rounded-lg shadow-sm hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black dark:focus:ring-white transition-colors font-medium"
          >
            Access Admin Panel
          </button>
        </form>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white dark:bg-black p-4 rounded-xl shadow-sm border border-gray-200 dark:border-zinc-800">
        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Admin Dashboard</h2>
        <button
